...
PARAM_DICT['log_path'] = 'data/logs/mnist_13/'
PARAM_DICT['log_freq'] = 500
PARAM_DICT['print_freq'] = 200
PARAM_DICT['valid_freq'] = -1
PARAM_DICT['load_path'] = 'data/logs/mnist_12/ckpt-20000'
...
PARAM_DICT['phi_x'] = {'name': 'phi_x',
                       'nn_type': 'general_mlp',
                       'activation': 'relu',
                       'layers': [PARAM_DICT['in_dim'], 200, phi_x_out]}
...
PARAM_DICT['phi_z'] = {'name': 'phi_z',
                       'nn_type': 'general_mlp',
                       'activation': 'relu',
                       'layers': [PARAM_DICT['z_dim'], 200, phi_z_out]}
